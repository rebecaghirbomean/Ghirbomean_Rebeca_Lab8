...
namespace Ghirbomean_Rebeca_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        ...
        public void PopulateAssignedCategoryData(Ghirbomean_Rebeca_Lab8Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Ghirbomean_Rebeca_Lab8Context context,string[] selectedCategories, Book bookToUpdate)
        {
